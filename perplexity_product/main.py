...
async def scrape_page(url: str) -> tuple[str, str, bool]:
    browser = None
    try:
...
async def main():
    load_dotenv()
    input_file = "hostnames.json"
    output_file = "enriched_data_primary.xlsx"
    ...
    sem = asyncio.Semaphore(scrape_parallel_amount)
